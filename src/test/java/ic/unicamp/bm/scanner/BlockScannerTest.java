...
class BlockScannerTest {
  ...
  void detectValidBlocks() {
    ...
    Path resourceDirectory1 = Paths.get("src", "test", "resources")
        .resolve("sourcecodeblocks1.txt");
    Path resourceDirectory2 = Paths.get("src", "test", "resources")
        .resolve("sourcecodeblocks2.txt");
    Path resourceDirectory3 = Paths.get("src", "test", "resources")
        .resolve("sourcecodeblocks3.txt");
    try {
